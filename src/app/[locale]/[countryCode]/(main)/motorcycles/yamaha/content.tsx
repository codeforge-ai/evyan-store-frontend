...
const enModels = [
  ...
  },
  {
    ...
    price: "€13,000",
    image: "/assets/yamaha/yamaha-tenere-700-rally-102110.jpg",
    features: ["Dual Fuel Tank", "Long Travel Suspension", "Rally-inspired"],
  },
  {
    name: "XSR900",
    category: "Retro",
  ...
  },
  {
    name: "FJR1300",
    category: "Sport Touring",
    engine: "1298 cc, 4-cylinder",
    power: "145 HP",
    price: "€14,500",
    image: "/assets/yamaha/yamaha-fjr1300-NEEDS_IMAGE.jpg",
    features: ["Cruise Control", "Comfortable ergonomics", "Advanced electronics"],
  },
  {
    name: "PW50",
    category: "Mini / Off-road",
    engine: "50 cc, single-cylinder",
    power: "? HP",
    price: "€1,800",
    image: "/assets/yamaha/yamaha-pw50-043425.jpg",
    features: ["Beginner-friendly", "Compact", "Low seat"],
  ...
  },
  {
    ...
    price: "€8,500",
    image: "/assets/yamaha/yamaha-yz250-f-438008.jpg",
    features: ["Fuel injection", "Balanced performance", "Race ready"],
  },
  {
    name: "YZ450F",
    category: "Motocross",
...
export default function YamahaPageContent() {
  const { locale } = useParams()
  const t = useTranslations("yamahaPage")

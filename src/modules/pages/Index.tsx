...
import { categories } from "./Echipamente"
import { brands } from "./Motociclete"
...
export default function Page() {
  ...
  // Instead, detect theme using a hook or context
  let isLightTheme = true
  if (typeof window !== "undefined") {
    isLightTheme = localStorage.getItem("theme") !== "dark"
  }
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                ...
                asChild
              >
                <Link href="/motociclete">Vezi Toate Motocicletele</Link>
              </Button>
              <Button
                size="lg"
                variant="outline"
                ...
                asChild
              >
                <Link href="/contact">Contactează Specialistul</Link>
              </Button>
            </div>
          </motion.div>
        </div>
